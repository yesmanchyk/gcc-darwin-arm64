...
static_assert ((add_const (^^int &), true)); // { dg-error ".const. qualifiers cannot be applied" }
static_assert ((add_volatile (^^int &), true)); // { dg-error ".volatile. qualifiers cannot be applied" }
